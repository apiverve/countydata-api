...
namespace APIVerve.API.CountyDataLookup
{
    ...
    /// <summary>
    /// Client for the CountyDataLookup API
    /// </summary>
    public class CountyDataLookupAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/countydata";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "county", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public CountyDataLookupAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountyDataLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountyDataLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CountyDataLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CountyDataLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(CountyDataLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CountyDataLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CountyDataLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CountyDataLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CountyDataLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CountyDataLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CountyDataLookupQueryOptions options)
        {
