...
const (
	baseURL        = "https://api.apiverve.com/v1/countydata"
	defaultTimeout = 30 * time.Second
)

// Client is the County Data Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new County Data Lookup API client.
...
// Execute makes a request to the County Data Lookup API with typed parameters.
//
