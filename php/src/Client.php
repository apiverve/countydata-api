...
/**
 * Client for the County Data Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/countydata?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/countydata';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CountydataClient] {$message}\n";
        }
    }
}
