# County Data Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:countydata-api:1.1.13'
}
```
...
```java
import com.apiverve.countydata.CountyDataLookupAPIClient;
import com.apiverve.countydata.APIResponse;
import com.apiverve.countydata.APIException;

// Initialize the client
CountyDataLookupAPIClient client = new CountyDataLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("state", "MO");
    parameters.put("county", "Jackson");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/countydata](https://docs.apiverve.com/ref/countydata)
...
- **Documentation:** [https://docs.apiverve.com/ref/countydata](https://docs.apiverve.com/ref/countydata)
- **Issues:** [GitHub Issues](https://github.com/apiverve/countydata-api/issues)
