...
class countydataWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/countydata');
        }
        ...
        this.validationRules = {"state":{"type":"string","required":true,"minLength":2,"maxLength":2},"county":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/countydata`);
        }
    }
