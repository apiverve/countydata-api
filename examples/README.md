# County Data Lookup API - Examples

This folder contains example code for using the County Data Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/countydata',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/countydata](https://docs.apiverve.com/ref/countydata)
