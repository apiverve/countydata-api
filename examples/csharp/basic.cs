...
{
    class CountyDataLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/countydata";

        /// <summary>
        /// Make a GET request to the County Data Lookup API
        /// </summary>
        static async Task<JsonDocument> CallCountyDataLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;state&quot;] &#x3D; &quot;MO&quot;, [&quot;county&quot;] &#x3D; &quot;Jackson&quot; };
        ...
        {
            Console.WriteLine("📤 Calling County Data Lookup API...\n");

            var result = await CallCountyDataLookupAPI();
